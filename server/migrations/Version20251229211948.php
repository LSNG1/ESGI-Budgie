 ...
 */
final class Version20251229211948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, type VARCHAR(50) DEFAULT NULL, description LONGTEXT DEFAULT NULL, tax_rate NUMERIC(5, 4) NOT NULL, rate_of_pay NUMERIC(6, 4) NOT NULL, overdraft NUMERIC(15, 2) DEFAULT NULL, created_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE subscription (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, max_accounts INT DEFAULT NULL, max_incomes INT DEFAULT NULL, max_expenses INT DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE user_account (id INT AUTO_INCREMENT NOT NULL, role VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, account_id INT NOT NULL, INDEX IDX_253B48AEA76ED395 (user_id), INDEX IDX_253B48AE9B6B5FBA (account_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
